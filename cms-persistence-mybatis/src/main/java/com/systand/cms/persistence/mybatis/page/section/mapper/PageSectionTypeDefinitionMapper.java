...
public final class PageSectionTypeDefinitionMapper {
    private PageSectionTypeDefinitionMapper() {
    }
    ...
    private static List<String> parseStrings(Object value) {
        ...
        return values.stream().map(PageSectionTypeDefinitionMapper::stringValue)
